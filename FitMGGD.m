...
%  figure, mesh(bin2, bin1, log(fitted));grid on;xlabel('Luminance'), ylabel('Disparity');% colormap([0 0 0]);title('with bivariate GGD fitting joint histogram');
%  figure, contour(bin2, bin1, log(fitted));grid on;title('contour for log-fitted');
%  xlabel('luminance'), ylabel('disparity'); 
% 
